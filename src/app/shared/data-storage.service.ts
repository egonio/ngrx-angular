...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    const req = new HttpRequest('PUT', 'https://http-test-e1b7e.firebaseio.com/recipes.json',
  ...
  getRecipes() {
    ...
    this.httpClient.get<Recipe[]>('https://http-test-e1b7e.firebaseio.com/recipes.json', {
      observe: 'body',
      responseType: 'json'
    })
      .map(
